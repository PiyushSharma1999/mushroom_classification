...
class KMeansClustering:
    ...
    def elbow_plot(self,data):
        ...
        """
        self.logger_object.log(self.file_object,'Entered the elbow_plot method of the LMeansClustering class')
        ...
        try:
            ...
            self.kn = KneeLocator(range(1,11),wcss,curve='covex',direction='decreasing')
